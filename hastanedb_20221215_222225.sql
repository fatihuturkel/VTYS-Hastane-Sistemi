...
CREATE TABLE public.ilac (
    ...
    isim character varying(40) NOT NULL,
    marka character varying DEFAULT '30'::character varying NOT NULL,
...
ALTER SEQUENCE public."ilac_ilac_ID_seq" OWNED BY public.ilac."ilac_ID";
...
ALTER SEQUENCE public."sigorta_sigorta_ID_seq" OWNED BY public.sigorta."sigorta_ID";
...
--
-- Name: ilac ilac_ID; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ilac ALTER COLUMN "ilac_ID" SET DEFAULT nextval('public."ilac_ilac_ID_seq"'::regclass);
...
--
-- Name: sigorta sigorta_ID; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sigorta ALTER COLUMN "sigorta_ID" SET DEFAULT nextval('public."sigorta_sigorta_ID_seq"'::regclass);
...
SELECT pg_catalog.setval('public."ilac_ilac_ID_seq"', 1, false);
...
SELECT pg_catalog.setval('public."sigorta_sigorta_ID_seq"', 1, false);
...
ALTER TABLE ONLY public.sigorta
    ADD CONSTRAINT sigorta_pkey PRIMARY KEY ("sigorta_ID");
...
ALTER TABLE ONLY public."receteIlac"
    ADD CONSTRAINT "ilac_receteIlac_FK" FOREIGN KEY ("ilac_ID") REFERENCES public.ilac("ilac_ID") MATCH FULL;
...
ALTER TABLE ONLY public.hasta
    ADD CONSTRAINT "sigorta_hasta_FK" FOREIGN KEY ("sigorta_ID") REFERENCES public.sigorta("sigorta_ID") MATCH FULL;
